$(document).ready(function() {
    ...
    $(window).scroll(function() {
        ...
        if (scroll >= 50) {
            // $("header nav").addClass("border border-left-0 border-right-0 border-top-0 border-white");
            $("header nav").addClass("fixed-top");
        } else {
            // $("header nav").removeClass("border border-left-0 border-right-0 border-top-0 border-white");
